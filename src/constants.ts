...
export const GPT_56_MODEL_IDS = ["gpt-5.6", "gpt-5.6-sol", "gpt-5.6-terra"] as const;
export const GPT_56_UNSUPPORTED_MODEL_IDS = ["gpt-5.6-luna"] as const;
...
export const OPENAI_KNOWN_COSTS: Record<string, ProviderModelConfig["cost"]> = {
	"gpt-5.5": {
		...
		cacheRead: 0.5,
		cacheWrite: 5.0,
		tiers: [{ inputTokensAbove: 272000, input: 10.0, output: 45.0, cacheRead: 1.0, cacheWrite: 10.0 }],
	},
	[GPT_54_DEFAULT_MODEL_ID]: {
		...
		cacheRead: 0.25,
		cacheWrite: 2.5,
		tiers: [{ inputTokensAbove: 272000, input: 5.0, output: 22.5, cacheRead: 0.5, cacheWrite: 5.0 }],
	},
	[GPT_54_1M_MODEL_ID]: {
		input: 5.0,
		output: 22.5,
	...
	"gpt-5.6": {
		...
		cacheRead: 0.5,
		cacheWrite: 6.25,
		tiers: [{ inputTokensAbove: 272000, input: 10.0, output: 45.0, cacheRead: 1.0, cacheWrite: 12.5 }],
	},
	"gpt-5.6-sol": {
		input: 5.0,
		output: 30.0,
	...
	"gpt-5.6-terra": {
		...
		cacheRead: 0.25,
		cacheWrite: 3.125,
		tiers: [{ inputTokensAbove: 272000, input: 5.0, output: 22.5, cacheRead: 0.5, cacheWrite: 6.25 }],
	},
...
// Pi sends model.maxTokens as the default Anthropic max_tokens value. Claude
// adaptive xhigh/max efforts need the current upstream output ceilings.
